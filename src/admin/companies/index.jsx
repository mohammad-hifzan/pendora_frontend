...
import CompanyTable from '../../common/companies/companyTable';
          ...
          <div className="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div className="ui-block responsive-flex">
              <div className="ui-block-title">
                <div className="h6 title">Companies</div>
      ...
      <div className="container">
        <div className="row">
          <div className="col col-xl-12 col-lg-9 col-md-12 col-sm-12 col-12">
            ...
            <GlobalPagination url={'/v2/admin/companies'} setObject={setCompanies} filterQuery={{query: query}} />
          </div>
        </div>
      </div>
