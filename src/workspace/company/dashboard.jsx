								...
								<div className="ui-block-content">
									<ul className="statistics-list-count">
										<li>
											...
											<div className="count-stat">28.432
								...
								<div className="ui-block-content">
									<ul className="statistics-list-count">
										<li>
											...
											<div className="count-stat">450.623
								...
								<div className="ui-block-content">
									<ul className="statistics-list-count">
										<li>
											...
											<div className="count-stat">16.502
								...
								<div className="ui-block-content">
									<ul className="statistics-list-count">
										<li>
											...
											<div className="count-stat">390.822
							...
							<div className="ui-block responsive-flex h-100 mb-0">
								<div className="ui-block-title">
									...
									<div className="points align-right">
										...
										<span>
											<span className="statistics-point bg-yellow"></span>
											THIS YEAR
										</span>

										<span>
											<span className="statistics-point bg-primary"></span>
											LAST YEAR
										</span>
									...
									<div className="chart-with-statistic">
										<ul className="statistics-list-count">
											<li>
												<div className="points">
													<span>
														<span className="statistics-point bg-purple"></span>
														Status Updates
													</span>
												</div>
											...
											<li>
												<div className="points">
													<span>
														<span className="statistics-point bg-breez"></span>
														Multimedia
													</span>
												</div>
										...
										<div className="chart-js chart-js-pie-color">
											...
											<div className="general-statistics">16.502
								...
								<div className="ui-block-content">
									<div className="world-statistics">
										<div className="world-statistics-img">
											<img loading="lazy" src="/themes/themeAuthor/img/world-map.webp" alt="map" width="520" height="281" />
										</div>

										<ul className="country-statistics">
											<li>
												<img loading="lazy" src="/themes/themeAuthor/img/flag1.webp" alt="flag" width="16" height="11" />
												<span className="country">United States</span>
												<span className="count-stat">86.134</span>
											</li>
											<li>
												<img loading="lazy" src="/themes/themeAuthor/img/flag2.webp" alt="flag" width="16" height="11" />
												<span className="country">Mexico</span>
												<span className="count-stat">35.136</span>
											</li>
											<li>
												<img loading="lazy" src="/themes/themeAuthor/img/flag3.webp" alt="flag" width="16" height="11" />
												<span className="country">France</span>
												<span className="count-stat">12.600</span>
											</li>
											<li>
												<img loading="lazy" src="/themes/themeAuthor/img/flag4.webp" alt="flag" width="16" height="11" />
												<span className="country">Spain</span>
												<span className="count-stat">9.471</span>
											</li>
											<li>
												<img loading="lazy" src="/themes/themeAuthor/img/flag5.webp" alt="flag" width="16" height="11" />
												<span className="country">Ireland</span>
												<span className="count-stat">8.058</span>
											</li>
											<li>
												<img loading="lazy" src="/themes/themeAuthor/img/flag6.webp" alt="flag" width="16" height="11" />
												<span className="country">Argentina</span>
												<span className="count-stat">5.653</span>
											</li>
											<li>
												<img loading="lazy" src="/themes/themeAuthor/img/flag7.webp" alt="flag" width="16" height="11" />
						...
						<div className="col col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 mb-3">
							<div className="ui-block h-100 mb-0">
								...
								<div className="ui-block-content js-google-map">
									...
									<div id="us-chart-map" style={{width: "270px", height: "180px", maxWidth: "100%"}}></div>
									...
									<ul className="statistics-list-count style-2">
										<li>
											<div className="points">
													<span>
														<span className="statistics-point bg-blue"></span>
														Profile Visits
													</span>
											</div>
								...
								<div className="ui-block-content">
									<div className="skills-item">
										<div className="skills-item-info">
											<span className="skills-item-title">Orange Gradient Progress</span>
											<span className="skills-item-count"><span className="count-animate" data-speed="1000" data-refresh-interval="50" data-to="62" data-from="0"></span><span className="units">62%</span></span>
										</div>
									...
									<div className="skills-item">
										<div className="skills-item-info">
											...
											<span className="skills-item-count"><span className="count-animate" data-speed="1000" data-refresh-interval="50" data-to="46" data-from="0"></span><span className="units">46%</span></span>
										</div>
										<div className="skills-item-meter">
											<span className="skills-item-meter-active bg-purple" style={{width: "46%"}}></span>
										</div>
									</div>
									...
									<div className="skills-item">
										<div className="skills-item-info">
											...
											<span className="skills-item-count"><span className="count-animate" data-speed="1000" data-refresh-interval="50" data-to="79" data-from="0"></span><span className="units">79%</span></span>
										</div>
										<div className="skills-item-meter">
											<span className="skills-item-meter-active bg-blue" style={{width: "79%"}}></span>
										</div>
									</div>
									...
									<div className="skills-item">
										<div className="skills-item-info">
											...
											<span className="skills-item-count"><span className="count-animate" data-speed="1000" data-refresh-interval="50" data-to="34" data-from="0"></span><span className="units">34%</span></span>
										</div>
										<div className="skills-item-meter">
											<span className="skills-item-meter-active bg-breez" style={{width: "34%"}}></span>
										</div>
									</div>
									...
									<div className="skills-item">
										<div className="skills-item-info">
											...
											<span className="skills-item-count"><span className="count-animate" data-speed="1000" data-refresh-interval="50" data-to="95" data-from="0"></span><span className="units">95%</span></span>
										</div>
										<div className="skills-item-meter">
											<span className="skills-item-meter-active bg-yellow" style={{width: "95%"}}></span>
										</div>
									</div>
								</div>
								...
								<div className="ui-block-content">
									<div className="monthly-indicator-wrap">
										...
										<div className="monthly-indicator">
											...
											<div className="monthly-count">
												Paragraph
												<span className="period">Lorem ipsum dolor sit amet, consectetur icing elit, sed do eiusmod
							...
							<div className="ui-block h-100 mb-0">
								...
								<div className="ui-block-content">
									<div className="swiper-container" data-slide="fade">
										<div className="swiper-wrapper">
											<div className="swiper-slide">
												<div className="statistics-slide">
													<div className="count-stat" data-swiper-parallax="-500">248</div>
													<div className="title" data-swiper-parallax="-100">
														<span className="c-primary">Olympus</span> Posts Rank
													</div>
													<div className="sub-title" data-swiper-parallax="-100">The Olympus Rank measures the quantity of comments, likes and posts.</div>
												</div>
											</div>
											<div className="swiper-slide">
												<div className="statistics-slide">
													<div className="count-stat" data-swiper-parallax="-500">358</div>
													<div className="title" data-swiper-parallax="-100">
														<span className="c-primary">Olympus</span> Posts Rank
													</div>
													<div className="sub-title" data-swiper-parallax="-100">The Olympus Rank measures the quantity of comments, likes and posts.</div>
											...
											<div className="swiper-slide">
												<div className="statistics-slide">
													<div className="count-stat" data-swiper-parallax="-500">711</div>
													<div className="title" data-swiper-parallax="-100">
														<span className="c-primary">Olympus</span> Posts Rank
													</div>
													<div className="sub-title" data-swiper-parallax="-100">The Olympus Rank measures the quantity of comments, likes and posts.</div>
										...
										<div className="swiper-pagination pagination-blue"></div>
									</div>
								</div>
							</div>
						</div>
							...
							<div className="ui-block h-100 mb-0">
								...
								<div className="ui-block-content">
									...
									<div className="chart-js chart-radar">
										<canvas className="radar-chart" id="radar-chart" width="400" height="300"></canvas>
									</div>
